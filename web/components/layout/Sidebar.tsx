...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 glass-card border-r border-[#e5e4de] min-h-screen pt-20 pb-6 px-4">
              ...
              <motion.div
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                  isActive
                    ...
                    : "text-[#0f3d2e]/70 hover:bg-[#0f3d2e]/5 hover:text-[#0f3d2e]"
                }`}
              >
